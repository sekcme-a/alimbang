...
import HeaderNav from "components/car/HeaderNav"
...
const JobList = () => {
    ...
    useEffect(()=>{
        const prem = addDamBang2("car", get_level_list(selectedList, "프리미엄 구인", "중고차"))
        const spe = addDamBang2("car", [...get_level_list(selectedList, "스페셜+ 구인", "중고차"),...get_level_list(selectedList, "스페셜 구인", "중고차")])
        const nor = [...get_level_list(selectedList, "일반+ 구인", "중고차"),...get_level_list(selectedList, "일반 구인", "중고차")]
        setPremiumList(prem)
        setSpecialList(spe)
        setNormalList(nor)
                    ...
                    <HeaderNav />
                        ...
                        {/* </div> */}
                            ...
                            {specialList.length!==0 && 
                                <>
                                    <h4 style={{marginTop:"30px", fontWeight:"bold", paddingLeft:"10px", marginBottom:"5px"}}>스페셜 중고차정보</h4>
                                    <Grid container spacing={{md:2, sm: 1, xs:1}} sx={{mt:"0px !important", padding: "0 10px", mb:"50px"}}>
                                        {
                            ...
                            {normalList.length!==0 &&   
                                <>
                                    <h4 style={{marginTop:"30px", fontWeight:"bold", paddingLeft:"10px", marginBottom:"5px"}}>일반 중고차정보</h4>
